...
namespace Homish.PresentationLayer
{
    public class Startup
    {
        ...
        {
            services.AddScoped<IPropertyDal, EfPropertyDal>();
            services.AddScoped<IAboutUsDal, EfAboutUsDal>();
            services.AddScoped<IStatisticsDal, EfStatisticsDal>();
            services.AddScoped<IPropertiesByAreaDal, EfPropertiesByAreaDal>();
